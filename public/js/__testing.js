        ...
        success: function (data) {
            ...
            $(document).on("click", ".reply", function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "/answers/check",
                    data: {question: questionId, answers: answers},
                    success: function (data) {
                        data = (typeof data === 'string') ? JSON.parse(data) : data;
                        console.log(data);
                        points += data.points;
                        index++;
                        if (testData.questions[index] !== undefined) {
                            questionBlock.innerHTML = '';
                            questionBlock.appendChild(initQuestion(testData.questions, index));
                            questionBlock.appendChild(initAnswers(testData.questions[index]));
                        } else {
                            console.log(points);
                        }
                    }
